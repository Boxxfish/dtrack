...
# This should be called before referencing any values.
...
func _update_deps(property: String, value):
...
func bind(component: Node, property_name: String, value_name: String):
